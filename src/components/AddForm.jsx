    ...
    return (
                        ...
                        <div className="add-form mt-2">
                            ...
                            <div className="input-group mt-2">
                                ...
                                <input name="dueDate" onChange={setField} type="text" className="form-control edit-exp-date" aria-describedby="taskNewExpDate" placeholder="Expiration date"></input>
                            </div>
